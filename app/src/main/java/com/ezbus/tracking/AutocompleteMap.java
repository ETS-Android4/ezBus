...
public class AutocompleteMap extends ArrayAdapter<AutocompletePrediction> implements Filterable {
     ...
     * successfully.
     * This method MUST be called off the bottom_menu UI thread, as it will block until data is returned
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            // This method should have been called off the bottom_menu UI thread. Block and wait for at most 60s
